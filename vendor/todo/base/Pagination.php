...
class Pagination
{
    ...
    public function __construct($total, $perpage = 3, $page = 1)
    {
        $page = $_GET['page'] ?? 1;
    ...
    public function getHtml() : string
    {
        ...
        return '<nav><ul class="pagination">' . $startpage.$back.$page2left.$page1left.'<li class="page-nav active"><span class="page-link">'.$this->currentPage.'</span></li>'.$page1right.$page2right.$forward.$endpage . '</ul></nav>';
    }
